...
export default function VacationKids() {
  return (
    <ScrollView style={[tw`flex-1 bg-gray-100`, { backgroundColor: "#F9FAFB" }]}>
      <View style={tw`p-4`}>
        <ChildBack title={"Vacation for Kids"} />
        ...
        <View style={tw`flex-row flex-wrap justify-between mt-4`}>
          <TouchableOpacity style={tw`bg-[#FDD831] w-[48%] h-[36px] rounded-full flex-row justify-center items-center mb-4`}>
            <Image tintColor={"black"} source={require('../../../assests/images/plus.png')} style={tw`w-4 h-4 mr-2`} />
            <Text style={tw`text-black text-12px`}>Add Money</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={tw`bg-[#FDD831] w-[48%] h-[36px] rounded-full flex-row justify-center items-center mb-4`}>
            <Image tintColor={"black"} source={require('../../../assests/images/plus.png')} style={tw`w-4 h-4 mr-2`} />
            <Text style={tw`text-black text-12px`}>Withdraw</Text>
          </TouchableOpacity>

          <TouchableOpacity style={tw`bg-[#FDD831] w-[48%] h-[36px] rounded-full flex-row justify-center items-center mb-4`}>
            <Image tintColor={"black"} source={require('../../../assests/images/plus.png')} style={tw`w-4 h-4 mr-2`} />
            <Text style={tw`text-black text-12px`}>History</Text>
          </TouchableOpacity>

          <TouchableOpacity style={tw`bg-[#FDD831] w-[48%] h-[36px] rounded-full flex-row justify-center items-center mb-4`}>
            <Image tintColor={"black"} source={require('../../../assests/images/plus.png')} style={tw`w-4 h-4 mr-2`} />
            <Text style={tw`text-black text-12px`}>Edit</Text>
          </TouchableOpacity>
        </View>
