...
const ChildQuestion = () => {
  ...
  const totalQuestions = 4; // Define the total number of questions
  ...
  const handleAnswerSelection = (index) => {
    ...
    // Delay before navigating to ChildQuestionTwo and passing progress
    setTimeout(() => {
      navigation.navigate('ChildQuestionTwo', { progress: newProgress }); // Pass progress to the next screen
    }, 1000); // 1 second delay for user to see the selected answer
  };
