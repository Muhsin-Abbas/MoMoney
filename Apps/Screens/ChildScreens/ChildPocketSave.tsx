  ...
  return (
    <View style={tw`flex-1 bg-white justify-center items-center px-8`}>
      ...
      <View style={tw`flex-row justify-between w-full`}>
        {/* Go back button */}
        <TouchableOpacity style={tw`border-2 border-yellow-500 rounded-full px-6 py-3 w-1/2 mr-2 justify-center items-center`}>
          <Text style={tw`text-yellow-500 font-semibold`}>Go back</Text>
        </TouchableOpacity>

        {/* Create Pocket button */}
        <TouchableOpacity 
        style={tw`bg-yellow-500 rounded-full px-6 py-3 w-1/2 ml-2 justify-center items-center`} 
        onPress={()=>navigation.navigate("Child_Pocket")}>
...
export default ChildPocketSave;
